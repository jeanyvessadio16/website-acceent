      ...
      <section className="relative min-h-[75vh] py-20 md:py-28 flex items-center justify-center overflow-hidden bg-slate-950 text-white">
        ...
        <div className="container relative z-10 mx-auto px-6 lg:px-8 flex flex-col items-center text-center">
          <FadeIn delay={0.1} direction="down">
            <span className="mb-6 inline-flex items-center gap-2 rounded-full border border-blue-400/30 bg-blue-500/15 backdrop-blur-md px-5 py-2 text-xs md:text-sm font-semibold tracking-wide text-blue-300 shadow-inner">
          ...
          <FadeIn delay={0.2} direction="up">
            <h1 className="max-w-4xl text-5xl sm:text-7xl lg:text-8xl font-black tracking-tight text-white mb-6 drop-shadow-md">
              ACCEENT
            </h1>
          </FadeIn>
          ...
          <FadeIn delay={0.3} direction="up" className="w-full max-w-3xl mx-auto mb-12">
            <div className="rounded-2xl border border-white/15 bg-white/10 backdrop-blur-md p-6 sm:p-8 shadow-2xl">
              <p className="text-lg sm:text-xl md:text-2xl text-slate-100 font-medium leading-relaxed">
                <span className="text-blue-400 font-black text-2xl sm:text-3xl">A</span>ction pour la{" "}
                <span className="text-blue-400 font-black text-2xl sm:text-3xl">C</span>ontribution{" "}
                <span className="text-blue-400 font-black text-2xl sm:text-3xl">C</span>ollective pour l&apos;
                <span className="text-blue-400 font-black text-2xl sm:text-3xl">É</span>ducation, l&apos;
                <span className="text-blue-400 font-black text-2xl sm:text-3xl">E</span>ntrepreneuriat et le{" "}
                <span className="text-blue-400 font-black text-2xl sm:text-3xl">N</span>umérique des{" "}
                <span className="text-blue-400 font-black text-2xl sm:text-3xl">T</span>erritoires
              </p>
            </div>
          </FadeIn>
          ...
          >
            {stats.map((stat, i) => (
              <StaggerItem key={i}>
                <div className="group relative rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-md shadow-xl hover:border-blue-400/30 hover:bg-white/10 transition-all duration-300 overflow-hidden text-center">
                  <p className="relative text-3xl sm:text-4xl font-extrabold text-blue-400 mb-1">
                    {stat.number}
                  </p>
      ...
      <section className="py-16 md:py-20 relative bg-white overflow-hidden">
        <div className="container mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            >
              <div className="absolute -inset-3 bg-gradient-to-tr from-blue-100 to-purple-50 rounded-[2.5rem] transform -rotate-2 group-hover:rotate-0 transition-transform duration-700 ease-out opacity-50" />
                ...
                <div className="flex flex-wrap gap-3">
                  {pillars.map((pillar) => (
                    <Link
                      key={pillar.title}
                      href={pillar.href}
                      className="group flex items-center gap-2.5 rounded-xl border border-slate-200/60 bg-slate-50 px-4 py-2.5 transition-all duration-300 hover:bg-white hover:shadow-md hover:shadow-slate-200/50 hover:border-blue-200"
                    >
                      <div className="flex h-7 w-7 items-center justify-center rounded-full bg-blue-100 text-blue-600 group-hover:scale-110 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">
