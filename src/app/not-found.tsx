    ...
    <div className="w-full min-h-[80vh] flex flex-col items-center justify-center px-6 py-20 relative overflow-hidden bg-background">
      ...
      <div className="text-center max-w-2xl mx-auto flex flex-col items-center z-10 w-full relative">
        ...
        <div className="relative mb-6 group">
          <h1 className="text-[140px] md:text-[200px] font-black text-transparent bg-clip-text bg-gradient-to-br from-primary via-primary/80 to-secondary/60 tracking-tighter leading-none select-none drop-shadow-sm transition-transform duration-500 group-hover:scale-105">
            404
          </h1>
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-primary/10 blur-3xl rounded-full -z-10 opacity-50 group-hover:opacity-100 transition-opacity duration-700"></div>
        </div>
        ...
        <div className="space-y-4 mb-10">
          ...
          <p className="text-fluid-p text-muted-foreground max-w-lg mx-auto">
            La page que vous recherchez semble avoir pris des vacances, a été déplacée ou n'a peut-être jamais existé.
          </p>
        </div>
