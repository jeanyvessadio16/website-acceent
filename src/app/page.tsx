          ...
          <div className="section-container">
            ...
            <ul className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 list-none p-0 m-0">
              {list_domaines.map((domaine) => (
                <li key={domaine.id}>
                  <Card className="group overflow-hidden rounded-2xl border border-slate-200/80 bg-white p-0 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl h-full">
                      ...
                      <div className="p-6 md:p-8">
                        ...
                        >
                          <Link href={domaine.page}>
                            En savoir plus sur {domaine.nom}
                          </Link>
                        </Button>
                      </div>
                    </CardContent>
